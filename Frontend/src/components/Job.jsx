    ...
    return (
        <div className='p-5 rounded-md shadow-xl bg-white border border-gray-200'> 
            ...
            <div className='flex items-center gap-4 mt-4'>
                <Button variant='outline' onClick={()=>navigate(`/description/${job?._id}`)} className='rounded-xl'>Details</Button>
                <Button className='bg-[#6A38C2] hover:bg-[#4101af] rounded-xl text-white'>Save For Later</Button>
            </div>
        </div>
    )
}
